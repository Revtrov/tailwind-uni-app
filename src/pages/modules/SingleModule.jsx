...
function SingleModule() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen">
      <div className="p-4 pb-6 bg-white dark:bg-gray-700 text-black dark:text-white rounded-lg shadow-md w-full max-w-md">
        {module ? (
          <div>
            ...
            <div className="mb-2">
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                {module.delivered_to.map((id) => (
                  <Link key={id} to={"/cohorts/" + id.split("cohort/")[1].replace("/", "")} className="px-2 py-1 bg-blue-500 text-white rounded hover:bg-blue-700">
            ...
            <Link to={"/modules/" + module.code + "/students"}className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-700">
              View Students
            </Link>
          </div>
        ) : (
