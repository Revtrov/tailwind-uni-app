function LoadingModuleCard() {
  return (
    ...
    >
      <div className="h-6 bg-gray-300 dark:bg-gray-600 w-3/4 mb-2"></div>
      <div className="h-6 bg-gray-300 dark:bg-gray-600 w-2/4 mb-2"></div>
      <div className="mt-auto">
        <div className="h-4 bg-gray-300 dark:bg-gray-600 w-1/3 mb-2"></div>
